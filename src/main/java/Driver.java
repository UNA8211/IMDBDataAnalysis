...
//        }
    ...
    private static void actorDiedBeforeMovieRelease(QueryEngine engine) {
        // 1960s
        Dataset sixtiesDead = engine.executeQuery(Queries.getActorDiedBeforeRelease(1960, 1970));
        ...
        // 1970s
        Dataset seventiesDead = engine.executeQuery(Queries.getActorDiedBeforeRelease(1970, 1980));
        ...
        // 1980s
        Dataset eightiesDead = engine.executeQuery(Queries.getActorDiedBeforeRelease(1980, 1990));
        ...
        // 1990s
        Dataset ninetiesDead = engine.executeQuery(Queries.getActorDiedBeforeRelease(1990, 2000));
        ...
        // 2000s
        Dataset zerosDead = engine.executeQuery(Queries.getActorDiedBeforeRelease(2000, 2010));
        ...
        // 2010s
        Dataset tensDead = engine.executeQuery(Queries.getActorDiedBeforeRelease(2010, 2020));
        ...
        // All time
        Dataset allTimeDead = engine.executeQuery(Queries.getActorDiedBeforeRelease(0, 2020));
